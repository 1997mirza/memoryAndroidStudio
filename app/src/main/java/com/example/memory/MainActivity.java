...
public class MainActivity extends AppCompatActivity {
    ...
    private void doStuff(ImageView iv, int card) {
        ...
        if (cardNumber == 1) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    //da li se odabrane karte poklapaju
                    calculate();
                }
            }, 1000);
        }
    ...
    private void calculate() {
        ...
        if (firstCard == secondCard) {
            ...
            playerPoints++;
            tv_p1.setText("Poeni: "+playerPoints);
    ...
    private void checkEnd() {
        if (iv_11.getVisibility() == INVISIBLE &&
                iv_12.getVisibility() == INVISIBLE &&
                iv_13.getVisibility() == INVISIBLE &&
                iv_14.getVisibility() == INVISIBLE &&
                iv_21.getVisibility() == INVISIBLE &&
                iv_23.getVisibility() == INVISIBLE &&
                iv_24.getVisibility() == INVISIBLE &&
                iv_31.getVisibility() == INVISIBLE &&
                iv_32.getVisibility() == INVISIBLE &&
                iv_33.getVisibility() == INVISIBLE &&
                iv_34.getVisibility() == INVISIBLE) {

            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MainActivity.this);
            alertDialogBuilder
                    .setMessage("Igra je zavrsena! \n Vas rezultat je: " + (100-countSec))
                    .setCancelable(false)
